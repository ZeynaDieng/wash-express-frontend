  ...
  <div class="py-32 animate-in fade-in max-w-7xl mx-auto px-6 text-left">
    ...
    <div class="max-w-4xl mx-auto mb-20 text-center space-y-8 animate-in slide-in-from-bottom-4 duration-700 delay-300">
      <div v-if="hero?.badge" class="p-8 rounded-3xl bg-white border-violet-500/20 shadow-xl relative overflow-hidden group hover:shadow-2xl transition-all">
        ...
        <h3 class="text-xs font-black tracking-[0.3em] text-primary mb-4 flex items-center justify-center gap-2">
      ...
      <p class="text-sm font-bold tracking-widest text-slate-400">
      ...
      >
        ...
        <div class="p-10 w-full relative z-10 flex flex-col h-full">
            ...
            <div class="bg-white/5 rounded-3xl p-6 mb-8 border border-white/5 backdrop-blur-sm space-y-6">
                <div class="space-y-1">
                    <p class="text-[9px] font-black tracking-[0.4em] text-slate-300">Investissement</p>
                ...
                <div class="space-y-1">
                    <p class="text-[9px] font-black tracking-[0.4em] text-secondary">Gain Estimé</p>
            ...
            <div class="space-y-4 mb-8">
                <div class="flex items-center justify-between text-sm font-bold text-slate-200 px-2">
                    <span class="text-slate-400 text-[10px] tracking-widest">Période de Carence</span>
                    <span>{{ pack.carence }}</span>
                </div>
                <div class="flex items-center justify-between text-sm font-bold text-slate-200 px-2">
                     <span class="text-slate-400 text-[10px] tracking-widest">Rentabilité</span>
            ...
            <button 
              ...
              class="mt-auto w-full py-5 rounded-2xl bg-secondary text-white font-black tracking-[0.3em] text-[10px] hover:bg-white hover:text-primary transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-3 group/btn active:scale-95"
            >
